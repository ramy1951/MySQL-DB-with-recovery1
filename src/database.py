...
class DB:
    ...
    def connect(self, database=None):
        ...
        try:
            ...
            connection = pymysql.connect(
                self._host, self._username, self._password, self._database)
            return connection
    ...
    def drop_database(self, database=None):
        ...
        query = self.DROP_DATABASE_QUERY + self._database
    ...
    def _execute_query(self, query, values, action=None):
        ...
        try:
            ...
            if values:
                # query will have wildcards as values
        ...
        try:
            ...
            for query in queries:
                if self._execute_query(query, values=None):  # execute each query
                    queries_executed += 1
            print("{} Executed queries from {}".format(
                queries_executed, sqlfile))
        except pymysql.InternalError as error:
            print(error.args[1])
